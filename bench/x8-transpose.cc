...
static void x8_transpose(
  ...
  BENCHMARK_CAPTURE(x8_transpose, neon_32_zip, xnn_x8_transpose_ukernel__16x16_neon_zip, 32)
      ->UseRealTime();
  BENCHMARK_CAPTURE(x8_transpose, neon_64_zip, xnn_x8_transpose_ukernel__16x16_neon_zip, 64)
      ->UseRealTime();
  BENCHMARK_CAPTURE(x8_transpose, neon_117_zip, xnn_x8_transpose_ukernel__16x16_neon_zip, 117)
      ->UseRealTime();
