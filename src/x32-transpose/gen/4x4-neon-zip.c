    ...
    size_t block_height)
{
  ...
  do {
    ...
    for (; bh >= 4; bh -= 4) {
      uint32x4_t v2_0 = vld1q_u32(i0); i0 = (uint32_t*) ((uintptr_t) i0 + input_offset);
      uint32x4_t v2_1 = vld1q_u32(i1); i1 = (uint32_t*) ((uintptr_t) i1 + input_offset);
      uint32x4_t v2_2 = vld1q_u32(i2); i2 = (uint32_t*) ((uintptr_t) i2 + input_offset);
      uint32x4_t v2_3 = vld1q_u32(i3); i3 = (uint32_t*) ((uintptr_t) i3 + input_offset);
    ...
    if (bh != 0) {
      uint32x4_t v2_0 = vld1q_u32(i0);
      if XNN_UNPREDICTABLE(bh < 2) {
        i1 = i0;
      }
      uint32x4_t v2_1 = vld1q_u32(i1);
      if XNN_UNPREDICTABLE(bh < 3) {
        i2 = i0;
      }
      uint32x4_t v2_2 = vld1q_u32(i2);
      uint32x4_t v2_3 = vmovq_n_u32(0);
