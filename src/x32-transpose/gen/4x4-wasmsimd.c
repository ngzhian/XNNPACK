    ...
    size_t block_height)
{
  ...
  do {
    ...
    if (bh != 0) {
      ...
      const v128_t v2_2 = wasm_v128_load(i2);
      v128_t v2_3 = wasm_v128_xor(v2_0, v2_0);
      v128_t v1_0 = wasm_v32x4_shuffle(v2_0, v2_2, 0, 4, 1, 5);
      v128_t v1_1 = wasm_v32x4_shuffle(v2_0, v2_2, 2, 6, 3, 7);
      v128_t v1_2 = wasm_v32x4_shuffle(v2_1, v2_3, 0, 4, 1, 5);
      v128_t v1_3 = wasm_v32x4_shuffle(v2_1, v2_3, 2, 6, 3, 7);
