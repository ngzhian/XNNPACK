    ...
    size_t block_height)
{
  ...
  do {
    ...
    if (bh != 0) {
      ...
      if (bh & 1) {
        uint8_t* oN = (uint8_t*) ((uintptr_t) o - oN_stride);
        *((uint8_t*) oN) = (uint8_t) _mm_cvtsi128_si32(v0_15);
        if XNN_UNPREDICTABLE(block_width >= 16) {
          oN = (uint8_t*) ((uintptr_t) oN + output_stride);
        }
        *((uint8_t*) oN) = (uint8_t) _mm_cvtsi128_si32(v0_14);
        if XNN_UNPREDICTABLE(block_width > 14) {
          oN = (uint8_t*) ((uintptr_t) oN + output_stride);
        }
        *((uint8_t*) oN) = (uint8_t) _mm_cvtsi128_si32(v0_13);
        if XNN_UNPREDICTABLE(block_width >= 14) {
          oN = (uint8_t*) ((uintptr_t) oN + output_stride);
        }
        *((uint8_t*) oN) = (uint8_t) _mm_cvtsi128_si32(v0_12);
        if XNN_UNPREDICTABLE(block_width > 12) {
          oN = (uint8_t*) ((uintptr_t) oN + output_stride);
        }
        *((uint8_t*) oN) = (uint8_t) _mm_cvtsi128_si32(v0_11);
        if XNN_UNPREDICTABLE(block_width >= 12) {
          oN = (uint8_t*) ((uintptr_t) oN + output_stride);
        }
        *((uint8_t*) oN) = (uint8_t) _mm_cvtsi128_si32(v0_10);
        if XNN_UNPREDICTABLE(block_width > 10) {
          oN = (uint8_t*) ((uintptr_t) oN + output_stride);
        }
        *((uint8_t*) oN) = (uint8_t) _mm_cvtsi128_si32(v0_9);
        if XNN_UNPREDICTABLE(block_width >= 10) {
          oN = (uint8_t*) ((uintptr_t) oN + output_stride);
        }
        *((uint8_t*) oN) = (uint8_t) _mm_cvtsi128_si32(v0_8);
        if XNN_UNPREDICTABLE(block_width > 8) {
          oN = (uint8_t*) ((uintptr_t) oN + output_stride);
        }
        *((uint8_t*) oN) = (uint8_t) _mm_cvtsi128_si32(v0_7);
        if XNN_UNPREDICTABLE(block_width >= 8) {
          oN = (uint8_t*) ((uintptr_t) oN + output_stride);
        }
        *((uint8_t*) oN) = (uint8_t) _mm_cvtsi128_si32(v0_6);
        if XNN_UNPREDICTABLE(block_width > 6) {
          oN = (uint8_t*) ((uintptr_t) oN + output_stride);
        }
        *((uint8_t*) oN) = (uint8_t) _mm_cvtsi128_si32(v0_5);
        if XNN_UNPREDICTABLE(block_width >= 6) {
          oN = (uint8_t*) ((uintptr_t) oN + output_stride);
        }
        *((uint8_t*) oN) = (uint8_t) _mm_cvtsi128_si32(v0_4);
        if XNN_UNPREDICTABLE(block_width > 4) {
          oN = (uint8_t*) ((uintptr_t) oN + output_stride);
        }
        *((uint8_t*) oN) = (uint8_t) _mm_cvtsi128_si32(v0_3);
        if XNN_UNPREDICTABLE(block_width >= 4) {
          oN = (uint8_t*) ((uintptr_t) oN + output_stride);
        }
        *((uint8_t*) oN) = (uint8_t) _mm_cvtsi128_si32(v0_2);
        if XNN_UNPREDICTABLE(block_width > 2) {
          oN = (uint8_t*) ((uintptr_t) oN + output_stride);
        }
        *((uint8_t*) oN) = (uint8_t) _mm_cvtsi128_si32(v0_1);
