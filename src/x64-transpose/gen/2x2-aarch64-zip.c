...
void xnn_x64_transpose_ukernel__2x2_aarch64_neon_zip(
    ...
    size_t block_height)
{
  ...
  do {
    ...
    for (; bh >= 2; bh -= 2) {
      uint64x2_t v1_0 = vld1q_u64(i0); i0 = (uint64_t*) ((uintptr_t) i0 + input_offset);
      uint64x2_t v1_1 = vld1q_u64(i1); i1 = (uint64_t*) ((uintptr_t) i1 + input_offset);
    ...
    if (bh != 0) {
      uint64x2_t v1_0 = vld1q_u64(i0);
      uint64x2_t v1_1 = vmovq_n_u64(0);
