...
#################################### ARM NEON ###############################
tools/xngen src/x32-transpose/neon-zip.c.in -D SIZE=8 ARCH=neon -o src/x8-transpose/gen/16x16-neon-zip.c &

################################## WAsm SIMD ##################################
tools/xngen src/x32-transpose/wasm-simd.c.in -D TILE_HEIGHT=16 TILE_WIDTH=16 SIZE=8 -o src/x8-transpose/gen/16x16-wasmsimd.c &
